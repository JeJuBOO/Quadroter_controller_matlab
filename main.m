...
% % title('\fontsize{15}Control input 企_{i}'),xlabel('Time t(s)'),ylabel('Control omega 企_{i} (rad/s)'),legend('企_{1}','企_{2}','企_{3}','企_{4}')
% grid on
% 
% figure()
% subplot(3,1,1)
% plot(times,rad2deg(s_save(7,:)))
% % title('\fontsize{15}Angles 仰,亥,份'), xlabel('Time t(s)'), ylabel('Angles'), legend('仰','亥','份')
% grid on
% subplot(3,1,2)
